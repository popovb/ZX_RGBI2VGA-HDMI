...
static int F_CAP_PIN = CapturedPins::f;

//программа захвата с делением входной частоты
u16 pio_program1_instructions[] = {
    
     0xa042, //  0: nop                               
     0xe020, //  1: set    x, 0                       
     (u16)(0x2000 | F_CAP_PIN), //  2: wait   1 gpio, 0                  
     0x4008, //  3: in     pins, 8                    
     (u16)(0x2080 | F_CAP_PIN), //  4: wait   0 gpio, 0                  
     0x0042, //  5: jmp    x--, 2    
     ...
     0x00c1, //  7: jmp    pin, 1                     
     0xe020, //  8: set    x, 0                       
     (u16)(0x2000 | F_CAP_PIN), //  9: wait   1 gpio, 0                  
     0x00c0, // 10: jmp    pin, 0  
     0x4008, //  11: in     pins, 8                      
     (u16)(0x2080 | F_CAP_PIN), // 12: wait   0 gpio, 1                  
     0x0049, // 13: jmp    x--, 9                     
